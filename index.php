...
<html>
<head>
<title>Launch Page: Dungeon Crawl Classics Elf Generator Version 2</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Dungeon Crawl Classics Elf Generator Version 2" class="image" /></h1>
        ...
        <p>Designed with PHP and jQuery, the Dungeon Crawl Classics Elf Character Generator randomly generates a character. The generator allows for the user to input different parameters to determine the character's level, equipment, weapons, alignment, etc.</p>    
    ...
    <div class="content9">
        ...
        <br/>
            ...
            <span class="formIputDescription">Armour:</span>	
			  <select id="armour" name="theArmour" class="alignmentBox">			
				...
				<option value="5">Mithril scale mail armour</option>
        ...
        <div class="formIputDescription">
           ...
           <br/>
                ...
                <span class="formIputDescription">Elf's Familar:</span>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#ElfForm").attr('action', "character/dccElf.php");
